  ...
  return (
    ...
    <Loader />
      <Canvas shadows camera={{ position: [0, 0, 20], fov:50 }}>
        ...
        <NissanZ scale={2.5} position={[0, 0, 0]} />
        </Suspense>
        <hemisphereLight intensity={0.5} />
        <ContactShadows position={[0, 0, 0.0]} opacity={0.75} scale={30} blur={2.5} far={0.8} />
        <ContactShadows resolution={1024} frames={1} position={[0, 0, 0]} scale={25} blur={1.5} opacity={0.5} far={20} />
